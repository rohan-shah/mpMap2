context("estimateRFInternal validation tests")
test_that("Arguments must have correct types",
	{
		#recombValues must be numeric
		expect_that(estimateRFInternal(object = NULL, recombValues = list(), lineWeights = NULL, markerRows = NULL, markerColumns = NULL, keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("recombinationFractions must be"))

		#recombValues must contain 0 and 0.5
		expect_that(estimateRFInternal(object = NULL, recombValues = 0.0, lineWeights = NULL, markerRows = NULL, markerColumns = NULL, keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("recombinationFractions did not contain"))
		expect_that(estimateRFInternal(object = NULL, recombValues = 0.5, lineWeights = NULL, markerRows = NULL, markerColumns = NULL, keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("recombinationFractions did not contain"))

		#Input object must be an S4
		expect_that(estimateRFInternal(object = NULL, recombValues = c(0.0, 0.5), lineWeights = NULL, markerRows = NULL, markerColumns = NULL, keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("object must be an S4"))
		...
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = NULL, markerRows = list(), markerColumns = NULL, keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("markerRows must be an integer"))

		#Input markerColumns must be an integer
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = NULL, markerRows = 1:2, markerColumns = list(), keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("markerColumns must be an integer"))

		#Input lineWeights must be a list
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = 1:2, markerRows = 1:2, markerColumns = 1:2, keepLod = NULL, keepLkhd = NULL, gbLimit = NULL, verbose = NULL), throws_error("lineWeights must be a list"))

		#gbLimit must be a single number
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = list(), markerRows = 1:2, markerColumns = 1:2, keepLod = NULL, keepLkhd = NULL, gbLimit = 1:2, verbose = NULL), throws_error("gbLimit must be a single numeric"))
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = list(), markerRows = 1:2, markerColumns = 1:2, keepLod = NULL, keepLkhd = NULL, gbLimit = c(1,2), verbose = NULL), throws_error("gbLimit must be a single numeric"))

		#lineWeights must have the right length
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = list(), markerRows = 1:2, markerColumns = 1:2, keepLod = NULL, keepLkhd = NULL, gbLimit = -1, verbose = NULL), throws_error("lineWeights had the wrong number of entries"))

		#keepLod must be a boolean
		expect_that(estimateRFInternal(object = cross, recombValues = c(0.0, 0.5), lineWeights = list(1), markerRows = 1:2, markerColumns = 1:2, keepLod = list(), keepLkhd = NULL, gbLimit = -1, verbose = NULL), throws_error("keepLod must be a boolean"))
