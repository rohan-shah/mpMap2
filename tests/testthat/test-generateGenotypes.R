...
test_that("Reject out of range recombination fractions",
{
	...
	expect_error(genotypes <- .Call("generateGenotypes", adjacentRecombination, markerNames, pedigree, PACKAGE="mpMap2"), "All recombination fractions must be between 0 and 0.5")
