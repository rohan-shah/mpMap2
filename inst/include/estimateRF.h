...
/** Estimate pairwise recombination fractions
  ...
  * @param markerRange1 The rows of markers (as a pair of indices) which we wish to consider
  * @param marker2Range The columns of markers (as a pair of indices) which we wish to consider
 ...
 **/
SEXP estimateRF(SEXP object, SEXP recombinationFractions, SEXP marker1Range, SEXP marker2Range, SEXP lineWeights, SEXP keepLod, SEXP keepLkhd);
#endif
